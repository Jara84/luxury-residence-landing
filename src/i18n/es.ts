const es = {
  ...
  hero: {
    location: "RESIDENCIA BOUTIQUE PRIVADA",
  ...
  signature: {
    label: "Características Exclusivas",

    title: "Una residencia diseñada alrededor del lujo cotidiano",
    ...
    balconies: {
      title: "Tres balcones privados",
      description:
        "Un balcón principal y dos balcones auxiliares amplían la experiencia de vivir tanto en interiores como en exteriores.",
    },
